...
@SpringBootTest
@AutoConfigureMockMvc // @SpringBootTest에서 MockMvc 쓸 경우
// Test를 위한 Property 우선 설정
...
public class ItemControllerTest {
    ...
    // 현재 회원 이름이 admin이고, role이 ADMIN인 유저가 로그인된 상태로 테스트를 할 수 있도록 해준다.
    @WithMockUser(username = "admin", roles = "ADMIN")
    public void itemFormTest() throws Exception {
        // 상품 등록 페이지에 요청을 get으로 보냄
